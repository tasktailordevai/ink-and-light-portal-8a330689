...
const practiceAreas = [
  { name: "Corporate Law", href: "/v3/practice-areas/corporate-law" },
  { name: "Real Estate", href: "/v3/practice-areas/real-estate" },
  { name: "Arbitration", href: "/v3/practice-areas/arbitration" },
  { name: "White Collar Crime", href: "/v3/practice-areas/white-collar-crime" },
  { name: "IBC & Insolvency", href: "/v3/practice-areas/ibc" },
];
...
export const Footer = () => {
  return (
    <footer className="bg-panel border-t border-line mt-0">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {practiceAreas.map((item) => (
                <li key={item.name}>
                  <Link to={item.href} className="text-foreground hover:text-ink-2 transition-colors">
                    {item.name}
                  </Link>
                </li>
              ))}
