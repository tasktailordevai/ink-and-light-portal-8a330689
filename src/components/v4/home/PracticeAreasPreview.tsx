          ...
          {practices.map((practice) => (
            <Link key={practice.title} to={practice.href} className="group">
              <Card className="h-full border-line hover:shadow-lg transition-all duration-200 hover:-translate-y-1" style={{ backgroundColor: "#002366" }}>
                <CardHeader>
                  <practice.icon className="h-8 w-8 mb-4 text-white" />
                  <CardTitle className="text-xl font-serif group-hover:text-white/90 transition-colors text-white">
                    {practice.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
