        ...
        <section className="py-24">
          <div className="mono-container">
            <div className="space-y-16">
              {team.map((member) => (
                <Card key={member.name} className="border-line overflow-hidden">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
                    ...
                    <CardContent className="lg:col-span-2 p-8 lg:p-12">
                      <div className="mb-4">
                        <h2 className="text-3xl font-serif font-semibold mb-2">{member.name}</h2>
                        <p className="text-lg text-muted-text mb-4">{member.title}</p>
                      ...
                      <div className="space-y-4 text-sm text-muted-text leading-relaxed mb-6">
                        <p>{member.bio}</p>
                      </div>
                      ...
                      <div className="space-y-3 text-sm border-t border-line pt-6">
                        <div>
                          ...
                          <p className="text-muted-text">{member.education}</p>
                        </div>
                        <div>
                          <span className="font-semibold text-foreground">Admissions:</span>
                          <p className="text-muted-text">{member.admissions}</p>
                        </div>
                      </div>
