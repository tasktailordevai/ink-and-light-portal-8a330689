        ...
        <section className="py-24 bg-background border-b border-line">
          <div className="mono-container">
            <div className="max-w-3xl">
              ...
              <p className="text-2xl text-muted-text font-serif font-medium">
                {data.tagline}
              </p>
            </div>
          </div>
                    ...
                    {data.examples.map((example: string, idx: number) => (
                      <Card key={idx} className="border-line">
                        <CardContent className="pt-6">
                          <p className="text-muted-text leading-relaxed">{example}</p>
                        </CardContent>
                      </Card>
                    ))}
                  </div>
                  ...
                  <Accordion type="single" collapsible className="space-y-4">
                    {data.faqs.map((faq: any, idx: number) => (
                      <AccordionItem key={idx} value={`item-${idx}`} className="border border-line rounded-lg px-6">
                        ...
                        <AccordionContent className="text-muted-text leading-relaxed pt-2">
                          {faq.answer}
                        </AccordionContent>
                      </AccordionItem>
                    ))}
                ...
                <Card className="border-line sticky top-24">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="pt-4 border-t border-line">
                      <p className="text-xs text-muted-text mb-2">Or reach us directly:</p>
                      <p className="text-sm font-medium">+91 40 1234 5678</p>
                      <p className="text-sm text-muted-text">contact@varunalaw.in</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
