        ...
        <section className="pt-24 pb-6 bg-background border-b border-line">
          <div className="mono-container">
            <div className="max-w-3xl">
              <h1 className="text-5xl sm:text-6xl font-serif font-semibold mb-4 tracking-tight">
                Contact Us
              </h1>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-sm">
                        ...
                        <a href="tel:+914012345678" className="text-foreground hover:text-foreground transition-colors">
                          +91 40 1234 5678
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-sm">
                        ...
                        <a href="mailto:contact@varunalaw.in" className="text-foreground hover:text-foreground transition-colors">
