        ...
        <section className="py-24 bg-background border-b border-line">
          <div className="mono-container">
            <div className="max-w-3xl">
              ...
              <p className="text-2xl text-foreground font-serif font-medium leading-relaxed">
              ...
              <div className="space-y-8">
                <Card className="border-line">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-foreground">Years Combined Experience</p>
                  </CardContent>
                </Card>
                <Card className="border-line">
                  <CardContent className="pt-6">
                    <div className="text-5xl font-serif font-bold mb-2">₹500Cr+</div>
                    <p className="text-foreground">Transaction Value Advised</p>
                  </CardContent>
                </Card>
                <Card className="border-line">
                  <CardContent className="pt-6">
                    <div className="text-5xl font-serif font-bold mb-2">100+</div>
                    <p className="text-foreground">Matters Successfully Resolved</p>
                  </CardContent>
                </Card>
              </div>
            </div>
